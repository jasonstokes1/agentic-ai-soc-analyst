...
SYSTEM_PROMPT_TOOL_SELECTION = {
    ...
    "content": ("""
      ...
      If querying AzureNetworkAnalytics_CL, use valid fields such as TimeGenerated, FlowStartTime_t, FlowType_s, SrcIP_s, DestIP_s, DestPort_d, FlowStatus_s, FlowDirection_s. Do not invent non-existent schema fields like MaliciousIP_s.
    ...
    "function_declarations": [
        {
            ...
            "parameters": {
                ...
                "required": [
                    ...
                    "about_individual_host", "about_network_security_group", "rationale"
                ]
            }
        }
    ]
